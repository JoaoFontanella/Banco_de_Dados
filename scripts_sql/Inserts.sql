...
INSERT INTO Documento (nome,titulo, conteudo, usuario_id, tipo_id) VALUES
('Relatorio.pdf','Relatório Anual 2023', 'Conteúdo do relatório anual de 2023', 1, 1),
('Contrato_serviço.pdf','Contrato de Prestação de Serviços', 'Detalhes do contrato de prestação de serviços', 2, 2),
('Memorando.pdf','Memorando Interno', 'Instruções internas sobre novo procedimento', 3, 3),
('Fatura_ti.pdf','Fatura de Serviços de TI', 'Detalhes da fatura dos serviços de TI', 4, 4),
('Plano_projeto.pdf','Plano de Projeto Alpha', 'Detalhes do plano de projeto Alpha', 5, 5);
